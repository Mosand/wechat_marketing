        ...
        <div class="container-fluid">
            ...
            <div>
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<%=basePath%>/purchase_findByPage.action"><strong>分页查询功能</strong></a></li>
...
<div class="container">
    ...
    <hr/>
    <br/>
    <form class="form-inline" action="<%=basePath%>/purchase_findByPage.action" method="post">
    ...
    <div class="table-responsive">
        <table class="table table-hover table-striped">
            ...
            <tbody>
            <c:forEach items="${requestScope.page.beanList}" var="purchase">
    ...
    <form class="listForm" method="post" action="<%=basePath%>/purchase_findByPage.action">
        <div class="row">
            <div class="form-inline">
                ...
                <ul class="pagination" style="float:right;">
                    <li>
                        <a href="<%=basePath%>/purchase_findByPage.action?pageCode=1"><strong>首页</strong></a>
                    </li>
                    <li>
                        <c:if test="${requestScope.page.pageCode > 2}">
                            <a href="<%=basePath%>/purchase_findByPage.action?pageCode=${requestScope.page.pageCode - 1}">&laquo;</a>
                        </c:if>
                    </li>
