...
function handlePaginationClick(new_page_index, pagination_container) {
	$("#proForm").attr("action", "<%=context %>/transaction_findAll.action?pageNum=" + (new_page_index +1));
	$("#proForm").submit();
	return false;
}
...
<body>
	<div>
		<form action="<%=context %>/transaction_findAll.action" id="proForm" method="post">
			商品名称 <input type="text" name="username" id="username" style="width: 120px" > &nbsp; 
			商品价格 <input type="text" name="time" id="time" style="width: 120px" > &nbsp; 
